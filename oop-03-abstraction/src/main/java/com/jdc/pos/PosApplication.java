...
//	}
	...
	public static void main(String[] args) {
		...
		var features = new AbstractFeature[] { new ProductAddFeature(1, productModel),
				new ProductSearchFeature(2, productModel), new SalesItemsFeature(3, productModel, saleModel),
				new SaleHistoryFeature(4, saleModel), new AbstractFeature(5, "Show Voucher") {

					@Override
					public void doBusiness() {
						System.out.println("Show Voucher Feature");
					}
				} 
		};
