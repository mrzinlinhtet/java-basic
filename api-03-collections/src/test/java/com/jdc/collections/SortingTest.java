...
public class SortingTest {
	...
	static Stream<Arguments> test_sorting_array_string_data() {
		return Stream.of(Arguments.of(new String[] { "C", "B", "A" }, new String[] { "A", "B", "C" }), Arguments
				.of(new String[] { "your name", "is", "aung aung" }, new String[] { "aung aung", "is", "your name" }));
	}
...
//		Collections.sort(input);
	...
	static Stream<Arguments> test_sorting_custom_object_data() {
		return Stream.of(Arguments.of(
				new Product[] { new Product(3, "Coke"), new Product(9, "Pespi"), new Product(5, "7Up"),
						new Product(2, "Vcode"), },
				new Product[] { new Product(2, "Vcode"), new Product(3, "Coke"), new Product(5, "7Up"),
						new Product(9, "Pespi"), }));
	}
